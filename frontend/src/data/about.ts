...
export const aboutSections: AboutSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Developing BOCRA as a dynamic, open, transparent and respected organization with highly competent and well motivated staff, which will be a model telecommunications regulatory body',
    ],
    icon: 'layers',
  },
  {
